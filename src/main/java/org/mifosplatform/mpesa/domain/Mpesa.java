...
public class Mpesa {
	...
	@Column(name = "routemethod_id")
	private String routemethodId;

	@Column(name = "routemethod_name")
	...
	public String getRoutemethodId() {
		return routemethodId;
	}

	public void setRoutemethodId(String routemethodId) {
