...
public interface MpesaBridgeRepository extends CrudRepository<Mpesa, Long>{
	...
	Page<Mpesa> LikeSearch(@Param("FromDate") Date FromDate,@Param("ToDate") Date ToDate,@Param("officeId") Long officeId, Pageable pageable);
	...
	Page<Mpesa>UnMappedOffice(@Param("status") String status,@Param("phoneNo") String phoneNo,@Param("FromDate") Date FromDate,@Param("ToDate") Date ToDate,@Param("officeId") Long officeId, Pageable pageable);
	...
	Page<Mpesa>Exactsearch(@Param("status") String status,@Param("phoneNo") String phoneNo,@Param("FromDate") Date FromDate,@Param("ToDate") Date ToDate,@Param("officeId") Long officeId, Pageable pageable);
	...
	Page<Mpesa>likesearch(@Param("phoneNo") String phoneNo,@Param("FromDate") Date FromDate,@Param("ToDate") Date ToDate,@Param("officeId") Long officeId, Pageable pageable);
	...
	Page<Mpesa>search(@Param("status") String status,@Param("FromDate") Date FromDate,@Param("ToDate") Date ToDate,@Param("officeId") Long officeId, Pageable pageable);
	...
	Page<Mpesa>unmappedofficed(@Param("status") String status,@Param("FromDate") Date FromDate,@Param("ToDate") Date ToDate,@Param("officeId") List<Long> officeId, Pageable pageable);
